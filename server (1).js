...
const server = http.createServer(async (req, res) => {
  ...
  // LINE Webhook — รับ event จาก LINE (ใช้หา User ID)
      ...
      try {
        ...
        for (const event of events) {
          ...
          if (userId) {
            ...
            console.log("==============================");
            // ตอบกลับ User ID ให้ผู้ใช้เห็นใน LINE ทันที
            await sendLine("🔑 User ID ของคุณคือ:
" + userId + "

คัดลอกไปใส่ใน LINE_USER_ID บน Render ได้เลย");
          }
        }
        res.writeHead(200);
        res.end("OK");
  ...
  // TradingView Webhook — รับ Alert จาก TradingView
